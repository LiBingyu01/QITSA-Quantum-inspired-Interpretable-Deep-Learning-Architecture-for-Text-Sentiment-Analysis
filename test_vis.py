...
class projection_Euler(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # plt.xlabel(f'Real Part of the {0}th Sentences in the Batch')
        # plt.ylabel('Values of Each Dimension')
        ...
        # plt.xlabel(f'Imaginary Part of the {0}th Sentences in the Batch')
        # plt.ylabel('Values of Each Dimension')
...
class run_complex_network(nn.Module):
    ...
    def forward(self, text, sentiment):
        ...
        # plt.title('WordEmbedding Vector of Text')
        # plt.ylabel('The Number of Word In the Sentence')
        # plt.xlabel('Sentiment Polarity of Word In Sentences')
